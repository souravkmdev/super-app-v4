...
const ServiceDetailScreen = ({ route }: { route: RoutePropType }) => {
    ...
    return (
        <LinearGradient
            ...
            style={{ flex: 1, paddingTop: insets.top + size.height * 2 }} >
            <StatusBar barStyle="dark-content" />
            <LinearGradient
                colors={['#d3cafb', '#e3dcffd2', '#fefeff47']}
                style={styles.barStyle}
            />
            <BookingHeader title={item.title} />
            ...
            >
                ...
                <View style={styles.aboutSection}>
                    ...
                    <Text style={styles.aboutDescription}>The Grand Vitra is a versatile SUV that combines style and functionality. With its spacious interior, advanced safety features</Text>
                </View>
                {/* Related Service */}
