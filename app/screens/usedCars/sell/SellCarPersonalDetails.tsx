...
const SellCarPersonalDetailsScreen = ({ navigation }: any) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Header title="Personal Details" onPress={() => navigation.goBack()} />

      <ScrollView
        showsVerticalScrollIndicator={false}
        contentContainerStyle={styles.scrollContent}
      >
        <StepperBar currentStep={2} steps={sellCarSteps} />
        ...
        <View style={styles.formCard}>
          ...
          <CustomInputComp
            ...
            compStyle={[styles.inputContainer, styles.fieldSpacing]}
            inputStyle={styles.inputText}
            LHSIcon={
              <MaterialCommunityIcons
                name="phone"
      ...
      <CustomButton
        TextValue="Continue"
        OnPress={() => navigation.navigate('SellCarEvaluate')}
